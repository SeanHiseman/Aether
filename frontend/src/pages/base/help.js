...
const Help = () => {
    ...
    const faqs = [
        ...
        { id: 'faq-3', question: 'Can I send messages?', answer: 'Messages will be added soon. You will be able to share posts with your connections.' },
        { id: 'faq-4', question: 'Will I get any notifications?', answer: 'Notifications will be added soon, along with options to turn them off.' },
        { id: 'faq-5', question: 'Why does my custom algorithm not work?', answer: 'We have a limited number of posts and customisation options for now, so not every custom algorithm can be satisfied.' },
        { id: 'faq-6', question: 'Why do some features not work on mobile?', answer: 'Let us know using the feedback form if you find any mobile issues.' },
        { id: 'faq-7', question: 'Do you have a mobile app?', answer: 'iOS and Android apps coming soon...' },
        { id: 'faq-8', question: 'How do I report a bug?', answer: 'Use the feedback form below your profile picture on the left aside. We really appreciate you helping us to improve!' },
        { id: 'faq-9', question: 'How do I contact support?', answer: 'support@aethersocial.com' },
        { id: 'faq-10', question: 'Are other languages supported?', answer: 'Not yet, but they will be added.' },
        { id: 'faq-11', question: 'How do you make money', answer: 'We will have a paid monthly subscription for premium features. This is being given away for free to our first 1000 users.' },
    ];
