...
const ConnectionWidget = ({ connection, connectRequest, onAccept, onReject, onRemove, viewerId }) => {
	...
	return (
		<div className="explore-block bg-gray-800 rounded-lg flex flex-col items-center">
			<Link to={`/u/${connection?.feed_name}`} className="w-20 h-20 rounded-full overflow-hidden mb-2">
				<img
