...
const DeepFeeds = sequelize.define(
  "deep_feeds",
  {
    ...
    parent_id: {
      type: STRING(36),
      allowNull: true,
      references: { model: "DeepFeeds", key: "deep_feed_id" },
    },
  },
  { tableName: "deep_feeds", timestamps: false }
);

const DeepFeedContent = sequelize.define(
  "deep_feed_content",
  {
...
const FeedChannels = sequelize.define(
  "feed_channels",
  {
...
const FeedChannelMessages = sequelize.define(
  "feed_channel_messages",
  {
...
const FollowRequests = sequelize.define(
  "follow_requests",
  {
