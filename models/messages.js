...
const ConnectRequests = sequelize.define('connect_requests', {
    ...
    sender_id: { type: STRING(36), allowNull: false, references: { model: 'Feeds', key: 'user_id' }},
    receiver_id: { type: STRING(36), allowNull: false, references: { model: 'Feeds', key: 'user_id' }}
