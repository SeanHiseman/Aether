...
import { AuthContext, ProtectedRoute, PublicAuthProvider } from './components/authContext';
...
// Component that handles the default redirect
const DefaultRedirect = () => {
    ...
    return <Navigate to={isAuthenticated ? "/explore" : "/welcome"} replace />;
};

// Component that wraps BaseLayout with additional providers
